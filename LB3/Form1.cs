...
namespace LB3
{
    ...
    {
        // Создание экземпляра контекста данных, который будет использываться
        ...
        protected override void OnLoad(EventArgs e)
        {
            ...
            // метод Load расширения используется для загрузки всех пользователей
            // из базы данных в BlogContext базу данных
            this.db.Users.Load();
